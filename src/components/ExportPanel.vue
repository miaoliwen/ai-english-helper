<template>
  <button @click="exportMarkdown"
          class="flex items-center gap-1.5 px-3.5 py-2 bg-neutral-100 hover:bg-neutral-200 text-neutral-600 rounded-xl transition-all duration-300 text-sm font-medium">
