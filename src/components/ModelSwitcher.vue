<template>
  <div
    ...
    :class="centered ? 'w-full flex justify-center' : ''"
  >
    <button
      ref="triggerRef"
      type="button"
      ...
      >
        ...
        <ul class="max-h-64 overflow-y-auto">
          ...
          <li
            ...
            class="px-2 py-3 text-xs text-neutral-400 text-center"
          >
            暂无预设
          </li>
        </ul>
        <div class="border-t border-neutral-100 dark:border-neutral-800 mt-1 pt-1">
          <button
            type="button"
            class="w-full flex items-center gap-1.5 px-2 py-2.5 rounded-md text-xs
                         text-neutral-500 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-800 transition-colors touch-target"
            @click="manage"
          >
            <svg
              class="w-3.5 h-3.5"
